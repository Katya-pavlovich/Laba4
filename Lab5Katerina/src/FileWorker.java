...
public class FileWorker {
    ...
    public FileWorker() throws UnsupportedEncodingException {
        this.bufferedReader = new BufferedReader(new InputStreamReader(System.in, "Cp1251"));
    }
    ...
    public void findWords(){
        ...
        for(int i = 0; i < count; i++){
            ...
            if(tokens[i].contains("«") && tokens[i].contains("»")){
                System.out.println(tokens[i].substring(tokens[i].indexOf('«')+1, tokens[i].indexOf('»')));
            }
        }
    }
